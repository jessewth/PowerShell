...
C:\91APP\nineyi.deployment\PowerShellScript\ConfigReplacement\ManuallyReplaceAppSettings.ps1 -sourceAppSettingsConfig $target -newAppSettingsConfig $mysetting
...
C:\91APP\nineyi.deployment\PowerShellScript\ConfigReplacement\ManuallyReplaceConnectionStrings.ps1 -sourceAppSettingsConfig $target -newAppSettingsConfig $mysetting